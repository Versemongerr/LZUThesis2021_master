...
\documentclass[AutoFakeBold]{template/LZUThesis2021_master}
...
\author{某某}
\majort{信息与通信工程·通信与信息系统}
\research{生物医学信息处理}
\education{硕\quad 士}
\advisor{某某\quad 教授}
\elapse{2021 年 3 月 \quad 至 \quad 2022 年 3 月}
\submitted{2022 年 3 月}
\defense{2022 年 5 月}
\giveda{2022 年 6 月}
...
%引入参考文献文件
%=======%
\bibliography{bib/database}%bib文件名称 仅修改bib/ 后部分
\printbib
